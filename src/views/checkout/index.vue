<script setup>
  import { getAdressAPI } from '@/apis/checkout.js'
  ...
  const getAdressFn = async () => {
    const res = await getAdressAPI()
    checkInfo.value = res.result
    const item = res.result.userAddresses.find((item) => item.isDefault === 0)
  ...
  <div class="xtx-pay-checkout-page">
    <div class="container">
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            <div class="text">
              ...
              <ul v-else>
                <li
                  ><span>收<i />货<i />人：</span>{{ curAddress.receiver }}</li
                >
                <li><span>联系方式：</span>{{ curAddress.contact }}</li>
                <li
                  ><span>收货地址：</span>{{ curAddress.fullLocation }} {{ curAddress.address }}</li
                >
              </ul>
            </div>
            <div class="action">
        ...
        <!-- 提交订单 -->
        <div class="submit">
          <el-button type="primary" size="large" @click="submitOrderFn">提交订单</el-button>
        </div>
      </div>
    </div>
  </div>

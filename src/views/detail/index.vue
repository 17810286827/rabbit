    ...
    <div class="container">
      <div class="bread-container" v-if="goods.categories">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/sub/category/${goods.categories[0].id}` }">{{ goods.categories[0].name }} </el-breadcrumb-item>
        ...
        <div>
          <div class="goods-info">
            ...
            <div class="spec">
              ...
              <!-- 数据组件 -->
              <el-input-number v-model="goodsNum" @change="addGoodsCount" />
              <!-- 按钮组件 -->
              <div>
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <el-image v-for="img in goods.details?.pictures" :key="img" :src="img" lazy></el-image>
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
